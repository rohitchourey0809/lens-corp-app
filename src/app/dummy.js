<div class="NewVision_qualification__sections__qWk8Y">
  <div class="">
    <div class="NewVision_qualification__data__s3l3X">
      <div>
        <h3 class="NewVision_qualification__title__HUzhX">
          Diversity &amp; Fairness
        </h3>
        <span class="NewVision_qualification__subtitle__EQ6HD">
      ...
      <div>
        <span class="NewVision_qualification__rounder__zWnvF">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            aria-hidden="true"
            role="img"
            class="NewVision_iconCol__90VMl iconify iconify--ic"
            width="38"
            height="32"
            viewBox="0 0 24 24"
          >
        ...
        <span class="NewVision_qualification__line__aQioP"></span>
      </div>
    </div>
    <div class="NewVision_qualification__data__s3l3X">
      <div></div>
      ...
      <div>
        ...
        <span class="NewVision_qualification__subtitle__EQ6HD">
          ...
          privacy regulations, such as the GDPR, HIPAA and others, in all our
          solutions handling sensitive data. We also ensure our algorithms allow
          for the required level of decision-making transparency and
          explainability.
        </span>
      </div>
    </div>
    <div class="NewVision_qualification__data__s3l3X">
      <div>
        <h3 class="NewVision_qualification__title__HUzhX">Code of Ethics</h3>
        <span class="NewVision_qualification__subtitle__EQ6HD">
          LENS believes in a just, non-violent world of equality and fairness.
          We prize democratic values, civil liberties and open and informed
          debate. When used to further these values, algorithm-based
          decision-making models can continue to make the world a safer, better
          place for everyone.
        </span>
      </div>
      <div>
